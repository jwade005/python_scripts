...
def hello():
   print(‘Hi NTI300!’)
   print(‘This is Jonathan’s Python Install Script.’)
...
def install_apache():
   ...
   os.system(‘sudo systemctl start http.service’)
...
def clone_github():
   ...
   print(‘Cloning jwade005’s GitHub.’)
...
def django_install():
   ...
   os.system(‘sleep 5’)
   os.system(‘cd django’)
   os.system(‘sudo virtualenv jango-env’)
...
import os
def dirty_cow():
   print(‘Cloning Dirty Cow Patches from jwade005’s GitHub.’)
   os.system(‘git clone https://hithub.com/jwade005/automation_scripts.git’)
