...
def publish_website():
   ...
   os.system('sh -c "cat install_scripts/index.html > /var/www/html/index.html"')
   os.system('sh -c "cat install_scripts/page2.html > /var/www/html/page2.html"')
   ...
   os.system('sh -c "cat install_scripts/.htaccess > /var/www/html/.htaccess"')
   os.system('sh -c "cat install_scripts/.htpasswd > /var/www/html/.htpasswd"')

   print('Adjusting Permissions.')
   os.system('chmod 644 /var/www/html/.htaccess')
   os.system('chmod 644 /var/www/html/.htpasswd')
